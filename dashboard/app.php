  ...
  <main class="max-w-screen-xl mx-auto px-5  ">
    <div class="flex flex-col md:flex-row rounded">
      ...
      <section id="posts" class="w-full px-4 ">
        ...
        <!-- Posts -->
        <div id="post" class="  flex box-border border-2 border-slate-800		mb-4  rounded-lg ">
          <!-- Single Post -->
          <!-- ------------------------------------------------------------------------------------- -->
          ...
          <!-- Comments Section -->
          <div
            class=" activea comments-section  rounded-lg p-6 bg-gray-900 text-gray-200  h-full max-h-[520px] overflow-y-scroll ">
            <!-- Add New Comment -->
            <div>
              <textarea
